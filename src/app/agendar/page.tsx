...
export default function Agendamento() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast.success(
      "Seu horário foi agendado com sucesso! Te esperamos na hora marcada 😎"
    );
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setFormData({ ...formData, barbeiroId: value })
                  }
                >
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setFormData({ ...formData, servicoId: value })
                  }
                >
              ...
              {/* name */}
              <div className="space-y-2">
                <Label htmlFor="name">Seu name</Label>
                <Input
                  id="name"
                  type="text"
                ...
                formData.horario && (
                  <Card className="p-4 bg-primary/10 border-primary/20">
                    ...
                    <div className="space-y-2 text-sm">
                      <p>
                        <strong>Barbeiro:</strong> {barbeiroSelecionado.name}
                      </p>
                      <p>
                      ...
                      <p>
                        <strong>Data:</strong>{" "}
                        {new Date(formData.data + "T00:00").toLocaleDateString(
                          "pt-BR"
                        )}
                      </p>
                      <p>
                      ...
                      <p>
                        ...
                        {servicoSelecionado.preco.toFixed(2)}
                      </p>
                    </div>
                  </Card>
                )}
